...
public class ProductRaw {
    ...
    public ProductRaw(ProductFlatDto productFlatDto) {
        ...
        this.measure = new Measure(productFlatDto.getNumberOfItemsInPack(), productFlatDto.getMeasureType(), productFlatDto.getMeasureCount(),productFlatDto.getUnitOfMeasure());
